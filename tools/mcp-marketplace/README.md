...
Aetheris CoRag 扩展的 MCP (Model Context Protocol) 工具市场，提供可复用的工具模板供开发者使用。
...
```go
import (
    "github.com/Colin4k1024/Aetheris/v2/tools/mcp-marketplace/tools"
)
```
...
所有 MCP 市场工具都实现 `internal/tool.Tool` 接口：
