...
=== RUN   TestFrameworkFactory_CreateFramework_SOX
--- PASS: TestFrameworkFactory_CreateFramework_SOX (0.00s)
...
PASS
ok  	github.com/Colin4k1024/Aetheris/v2/pkg/compliance	2.050s
```
...
PASS
ok  	github.com/Colin4k1024/Aetheris/v2/internal/api/http	(cached)
```
