...
- **Getting started**: This README → [guides/get-started.md](guides/get-started.md) → [guides/usage.md](guides/usage.md) → [design/core.md](../design/core.md), [design/struct.md](../design/struct.md)
...
Architecture and design documents in the `design/` directory.
