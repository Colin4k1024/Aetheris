...
- **Item-level checklist (Risk, Effort, Module)**: [concepts/improvement-checklist-1.0-to-2.0.md](../concepts/improvement-checklist-1.0-to-2.0.md)
- **Phase timeline and Gantt**: [2.0-roadmap-timeline.md](2.0-roadmap-timeline.md)
- **2.0 modules and phases**: [design/aetheris-2.0-overview.md](../design/aetheris-2.0-overview.md)
- **1.0 release baseline**: [releases/release-checklist-v1.0.md](../releases/release-checklist-v1.0.md)
- **Scenario walkthroughs**: [guides/getting-started-agents.md](../guides/getting-started-agents.md)
