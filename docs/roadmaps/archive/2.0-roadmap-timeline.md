...
- **Improvement checklist (source table)**: [concepts/improvement-checklist-1.0-to-2.0.md](../concepts/improvement-checklist-1.0-to-2.0.md)
- **2.0 modules and phases**: [design/aetheris-2.0-overview.md](../design/aetheris-2.0-overview.md)
- **Eight-week 2.0 coding plan**: [concepts/next_plan.md](../concepts/next_plan.md)
