...
Requires **Go 1.26.1+** (aligned with go.mod and security fixes). For a first-time setup and full core-feature walkthrough (快速体验 vs 完整运行时), see [Get Started](get-started.md).
...
- For per-file config reference see [Configuration (config.md)](../reference/config.md).
