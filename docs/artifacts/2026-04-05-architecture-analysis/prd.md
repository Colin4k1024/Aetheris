...
> Historical note (2026-05-25): 本 PRD 中关于 Effect Store “事件流优先” 的备选方向已被后续强 Replay 契约取代。当前权威契约见 [effect-store-contract.md](../../../design/internal/effect-store-contract.md)。
...
2. **CRITICAL - Runtime**
   ...
   - Effect Store 写入纳入事务或改用事件流优先（historical；current: PutEffect before committed/finished events）
