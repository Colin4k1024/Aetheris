...
本文档将 Aetheris 在各类故障下的**保证是否成立**、**系统行为**与**推荐配置**整理为单一矩阵表。内容抽取自 [docs/runtime-guarantees.md](../../docs/guides/runtime-guarantees.md) 与 [design/scheduler-correctness.md](scheduler-correctness.md)，用于合规说明与运维决策。
...
- [docs/runtime-guarantees.md](../../docs/guides/runtime-guarantees.md) — 各场景详细说明与示例
- [scheduler-correctness.md](scheduler-correctness.md) — 租约、attempt_id、两步提交
- [execution-guarantees.md](../execution-guarantees.md) — 正式保证与成立条件
- [formal-state-machine.md](formal-state-machine.md) — Job 状态机形式化
